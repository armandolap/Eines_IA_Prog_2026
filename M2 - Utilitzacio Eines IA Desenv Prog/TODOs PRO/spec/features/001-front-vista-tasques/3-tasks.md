...
[x] T1 — index.html: esquelet, CDN de Tailwind + config de la skill estil-todos, style.css enllaçat.
[x] T2 — Capçalera amb títol i comptador.
[x] T3 — Targeta d'afegir: camp + botó.
