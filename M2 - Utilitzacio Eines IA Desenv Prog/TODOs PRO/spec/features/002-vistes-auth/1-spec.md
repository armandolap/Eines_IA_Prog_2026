...
public/login.html i public/registre.html, maquetades i validades. Sense backend encara: si tot és correcte, naveguen (login → index.html, registre → login.html); la 007 hi posarà comptes de veritat.
