...
## Objectiu
Crear un lloc web estàtic de diverses pàgines sobre la Història de Barcelona, amb un disseny net i navegació interna.
...
### estils.css
- Estil modern i net
- Tipografia serif per a títols, sans-serif per a text
- Colors: fons clar, text fosc, accent blau marí
- Imatges responsives amb vores arrodonides
- Peu de foto estilitzat
...
### Paleta
- `#0F1923` Slate — fons del hero / top-bar
- `#2A6B8A` Blau mediterrani — accents, enllaços
- `#C4953C` Or romà — regles decoratives, hover, lletres capitals
- `#E8E0D6` Pedra calcària — fons de pàgina
- `#FBF8F4` Pedra clara — targetes i superfícies
- `#8B3A30` Terracota — accent secundari

### Tipografia
- Títols: **Cinzel** (serif romaní, Google Fonts)
- Cos: **Source Serif 4** (serif càlid per a lectura)
- Utilitat: **Inter** (sans-serif per a etiquetes i navegació)
