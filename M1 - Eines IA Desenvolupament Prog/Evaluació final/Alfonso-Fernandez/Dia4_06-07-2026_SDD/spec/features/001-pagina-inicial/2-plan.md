...
<section id="…"> → una tarjeta por tema (×7) 
<h2> → título del tema 
<p> → intro 
...
- **Single-page con anclas:** los 7 `yd` de la spec son el contrato entre menú y secciones; deben coincidir exactamente.
- **Tarjetas en grid:** cada tema es una tarjeta según la skill (`rounded-xl`, `p-6`, hover sutil con `acento`).
...
Abrir `index.html` en el navegador y comprobar, uno por uno, los criterios de aceptación de la spec (navegación, menú móvil, 7 temas, parrilla responsiva, colores de la paleta).